            ...
            <div className="flex overflow-x-auto gap-3 pb-2 scrollbar-hide -mx-2 px-2">
               {days.slice(0, 14).map((d) => (
                  <button
                    ...
                    className={`flex flex-col items-center min-w-[60px] p-3 rounded-[20px] transition-all border-2 ${
               ...
               {periods.map((period, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-[24px] border-2 text-left relative overflow-hidden transition-all ${
                        isUnavailable 
